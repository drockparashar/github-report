...
async function generateJsonFromGemini({ apiKey, model, prompt }) {
...
export async function analyzeInBatches({
  ...
  const chunks = chunkArray(compactCommits, DEFAULTS.batchSize);
  ...
  onProgress?.("Merging duplicate features...");
  try {
